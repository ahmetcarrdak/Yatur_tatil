        ...
        <div class="card">
            ...
            <div class="table-responsive text-nowrap">
                <table id="example" class="mdl-data-table">
                    ...
                    <?php
                    /** @var TYPE_NAME $conn */
                    $veriIslem = "SELECT * FROM acentalar where onay=1 ORDER BY id DESC";
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                <span
                                    style="color: #2b517c;font-size: 15px">Tel:</span> <?php echo $acenta['phoneNo'] ?>
                            </div>
                            <div class="col-lg-6 mb-3" style="text-align: right">
                                <span
                                    style="color: #2b517c;font-size: 15px">e-Mail:</span> <?php echo $acenta['email'] ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-3" style="text-align: left">
                                <span
                                    style="color: #2b517c;font-size: 15px">Pasaport No:</span> <?php echo $acenta['pasaportNo'] ?>
                            </div>
                        </div>

                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-success" data-bs-dismiss="modal" disabled>
                            Onaylanmış
                        </button>
