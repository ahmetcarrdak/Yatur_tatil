...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <!-- Responsive Table -->
        <div class="card">
            <h5 class="card-header">Başvurular ve Acentalar Listesi</h5>
            <div class="table-responsive text-nowrap">
                <table id="example" class="mdl-data-table">
                    ...
                    <?php
                    /** @var TYPE_NAME $conn */
                    $veriIslem = "SELECT * FROM basvuru where onayDurum=0 ORDER BY id DESC";
                        ...
                        foreach ($veriIslem3 as $acenta) {
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                    <a
                                        href="component/basvuruOnayla?no=<?php echo $acenta['id'] ?>"
                                        type="button"
